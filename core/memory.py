...
def _is_same_recent_visit(last_entry: Dict[str, Any], new_symptoms: str,
...
def update_patient_memory(
    ...
    # If the latest visit is actually the same recent visit, overwrite it
    if history:
        ...
        if _is_same_recent_visit(last_entry, symptoms, window_minutes=5):
            ...
            save_memory(memory)
            return
    # Otherwise append as a genuinely new visit
